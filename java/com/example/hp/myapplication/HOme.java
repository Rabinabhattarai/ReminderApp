...
import com.example.hp.myapplication.Reminder.reminderlist;
...
public class HOme extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_routines) {
         ...
         else if (id == R.id.nav_hlth) {
            Intent intent = new Intent(getApplicationContext(), healthfrstpage.class);
            intent.putExtra("EMAIL", mEmail);
            startActivity(intent);

        } else if (id == R.id.nav_wtr) {
